...
const Header = () => {
  return (
    <div className="border-b-2 border-subtle pb-5 mb-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-muted font-mono">Neural Semantic RAG Engine</p>
          </div>
        </div>

        <div className="flex items-center gap-2.5 bg-surface/90 border-2 border-subtle/80 px-3.5 py-1.5 text-xs md:text-sm font-mono shadow-[2px_2px_0px_0px_#1e293b]">
          <span className="w-2.5 h-2.5 bg-emerald-400 animate-pulse shadow-[0_0_8px_#34d399]"></span>
          <span className="text-foreground font-bold">FAISS ACTIVE</span>
        </div>
      </div>
    </div>
  );
